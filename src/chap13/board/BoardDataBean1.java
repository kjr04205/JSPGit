...
public class BoardDataBean1 {
	...
	public String toString() {
		return "BoardDataBean1 [num=" + num + ", writer=" + writer + ", email=" + email + ", subject=" + subject
				+ ", passwd=" + passwd + ", reg_data=" + reg_data + ", readcount=" + readcount + ", ref=" + ref
